...
use super::{
    ...
    section::SectionCode,
    types::{
        Data, Export, ExportDesc, FuncType, Function, FunctionLocal, Import, ImportDesc, Limits,
        Memory, ValueType,
    },
};
...
mod tests {
    ...
    use crate::binary::{
        instruction::Instruction,
        types::{
            Data, Export, ExportDesc, FuncType, Function, FunctionLocal, Import, ImportDesc,
