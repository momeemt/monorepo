...
このテーマは同日に提出された浅田睦葉さんと共同で進めているプロジェクトで、担当箇所を明確に切り分けています。
...
また、細かく調整した設定について、Wordが意図を汲んだつもりで勝手に変更を加えることもあります。そのため、少し執筆しては確認、という作業を繰り返すことが多くなり、執筆体験が損なわれることがありました。
