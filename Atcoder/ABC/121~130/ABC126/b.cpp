...
signed main() {
  ...
  // ここから
  IN(s);
  int num1 = stoll(s.substr(0,2));
  int num2 = stoll(s.substr(2,2));
  if(MIDe(1,num1,12) && MIDe(1,num2,12)) OUT("AMBIGUOUS");
  else if(MIDe(1,num1,12)) OUT("MMYY");
  else if(MIDe(1,num2,12)) OUT("YYMM");
  else OUT("NA");
}