...
これを認めればプラグインの塩梅によってユーザが記法を理解するために新たな負担を受ける可能性があり、Brackの最小の文法と拡張による言語というコンセプトも壊れかねませんが、
現状のHTMLバックエンドを想定したコマンド呼び出し構文の分別も一貫性がありません。
// うえかんにスニペットがダメだった理由を後で聞く

//  スニペットで展開されたコードがエラーになってたら詰みそうじゃない？ → マジでそう
