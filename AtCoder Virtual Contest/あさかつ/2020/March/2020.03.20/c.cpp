...
signed main() {
  ...
  REP(i,n){
    char p = str[i][0];
    if(p=='M'||p=='A'||p=='R'||p=='C'||p=='H') mp[p]++;
  }
  int sume = mp['M'] * mp['A'] * mp['R'] + mp['M'] * mp['A'] * mp['C'] + mp['M'] * mp['A'] * mp['H'] + mp['M'] * mp['R'] * mp['C'] + mp['M'] * mp['R'] * mp['H'] + mp['M'] * mp['C'] * mp['H'] + mp['A'] * mp['R'] * mp['C'] + mp['A'] * mp['R'] * mp['H'] + mp['A'] * mp['C'] * mp['H'] + mp['H'] * mp['R'] * mp['C'];
  OUT(sume);
}