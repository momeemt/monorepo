...
signed main() {
  ...
  if(n==1) {
    ...
    int p1 = max(T[0]+T[1], T[2]);
    int p2 = max(T[0], T[1]+T[2]);
    int p3 = max(T[0]+T[2], T[1]);
    out(min({p1, p2, p3}));
  } else {
    int p1 = max(T[0]+T[1], T[2]+T[3]);
    int p2 = max(T[0]+T[2], T[1]+T[3]);
    int p3 = max(T[0]+T[3], T[1]+T[2]);
    int p4 = max(T[0], T[1]+T[2]+T[3]);
    int p5 = max(T[1], T[0]+T[2]+T[3]);
    int p6 = max(T[2], T[0]+T[1]+T[3]);
    int p7 = max(T[3], T[0]+T[1]+T[2]);
    out(min({p1, p2, p3,p4,p5,p6,p7}));
  }
}